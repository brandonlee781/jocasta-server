# Migration `watch-20200115133303`

This migration has been generated by Brandon Lee at 1/15/2020, 1:33:03 PM.
...
ALTER TABLE "jocasta_schema"."DefenseAttribute" ADD COLUMN "derivedAttributes" text    REFERENCES "jocasta_schema"."DefenseAttribute"("id") ON DELETE SET NULL;
...
migration watch-20200115132800..watch-20200115133303
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
