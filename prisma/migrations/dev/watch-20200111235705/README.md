...
ALTER TABLE "jocasta_schema"."Skill" ADD COLUMN "specialization" integer    REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE SET NULL;
...
ALTER TABLE "jocasta_schema"."TalentTree" ADD COLUMN "specialization" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE RESTRICT,
...
ALTER TABLE "jocasta_schema"."Talent" ADD COLUMN "specialization" integer    REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE SET NULL;
...
migration watch-20200111234556..watch-20200111235705
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
