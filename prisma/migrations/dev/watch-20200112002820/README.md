# Migration `watch-20200112002820`

This migration has been generated by Brandon Lee at 1/12/2020, 12:28:21 AM.
...
CREATE TABLE "jocasta_schema"."_SpecializationToTalent" (
  ...
  "B" text  NOT NULL  REFERENCES "jocasta_schema"."Talent"("id") ON DELETE CASCADE
);
...
ALTER TABLE "jocasta_schema"."Talent" DROP COLUMN "specialization",
DROP COLUMN "description",
ADD COLUMN "description" text    ,
DROP COLUMN "page",
...
migration watch-20200112001351..watch-20200112002820
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
