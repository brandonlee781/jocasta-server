...
ADD COLUMN "talent" integer    REFERENCES "jocasta_schema"."Talent"("id") ON DELETE SET NULL;
...
ADD COLUMN "specialization" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE RESTRICT;
...
migration watch-20200112175008..watch-20200112175533
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
