# Migration `watch-20200115131558`

This migration has been generated by Brandon Lee at 1/15/2020, 1:16:07 PM.
...
ALTER TABLE "jocasta_schema"."CharacterSkill" DROP COLUMN "character",
...
migration watch-20200115131413..watch-20200115131558
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
...
-  rank      Int       @default(0)
-  character Character @relation(references:[id])
+  career    Boolean     @default(true)
+  rank      Int         @default(0)
