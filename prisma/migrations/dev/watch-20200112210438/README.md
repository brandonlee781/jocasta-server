# Migration `watch-20200112210438`

This migration has been generated by Brandon Lee at 1/12/2020, 9:05:22 PM.
...
ALTER TABLE "jocasta_schema"."TalentTreeNode" ADD COLUMN "specializations" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE RESTRICT,
...
DROP TABLE "jocasta_schema"."_SpecializationToTalentTreeNode";
```
...
migration watch-20200112194736..watch-20200112210438
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
