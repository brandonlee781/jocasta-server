# Migration `watch-20200112000311`

This migration has been generated by Brandon Lee at 1/12/2020, 12:03:11 AM.
...
ALTER TABLE "jocasta_schema"."Specialization" DROP COLUMN "career",
ADD COLUMN "career" integer    REFERENCES "jocasta_schema"."Career"("id") ON DELETE SET NULL;
...
migration watch-20200112000154..watch-20200112000311
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
