# Migration `watch-20200112194736`

This migration has been generated by Brandon Lee at 1/12/2020, 7:47:39 PM.
...
ALTER TABLE "jocasta_schema"."CharacterTalent" DROP COLUMN "column",
DROP COLUMN "row",
...
ADD COLUMN "character" text  NOT NULL  REFERENCES "jocasta_schema"."Character"("id") ON DELETE RESTRICT;
...
migration watch-20200112194422..watch-20200112194736
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
