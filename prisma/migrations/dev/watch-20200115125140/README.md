# Migration `watch-20200115125140`

This migration has been generated by Brandon Lee at 1/15/2020, 12:51:41 PM.
...
CREATE TABLE "jocasta_schema"."TalentTreeNode" (
...
CREATE TABLE "jocasta_schema"."_CharacterToSpecialization" (
  "A" text  NOT NULL  REFERENCES "jocasta_schema"."Character"("id") ON DELETE CASCADE,
  "B" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE CASCADE
);

CREATE TABLE "jocasta_schema"."_SkillToSpecialization" (
  "A" integer  NOT NULL  REFERENCES "jocasta_schema"."Skill"("id") ON DELETE CASCADE,
  "B" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE CASCADE
);

CREATE TABLE "jocasta_schema"."_SpecializationToTalent" (
  "A" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE CASCADE,
  "B" integer  NOT NULL  REFERENCES "jocasta_schema"."Talent"("id") ON DELETE CASCADE
);
...
ALTER TABLE "jocasta_schema"."Character" ADD COLUMN "characteristics" text    REFERENCES "jocasta_schema"."Characteristic"("id") ON DELETE SET NULL,
...
ALTER TABLE "jocasta_schema"."CharacterSkill" ADD COLUMN "character" text  NOT NULL  REFERENCES "jocasta_schema"."Character"("id") ON DELETE RESTRICT,
ADD COLUMN "skill" integer  NOT NULL  REFERENCES "jocasta_schema"."Skill"("id") ON DELETE RESTRICT;

ALTER TABLE "jocasta_schema"."Specialization" ADD COLUMN "career" integer    REFERENCES "jocasta_schema"."Career"("id") ON DELETE SET NULL;

ALTER TABLE "jocasta_schema"."TalentTreeNode" ADD COLUMN "specialization" integer  NOT NULL  REFERENCES "jocasta_schema"."Specialization"("id") ON DELETE RESTRICT,
ADD COLUMN "talent" integer  NOT NULL  REFERENCES "jocasta_schema"."Talent"("id") ON DELETE RESTRICT;
...
ADD COLUMN "talent" text  NOT NULL  REFERENCES "jocasta_schema"."TalentTreeNode"("id") ON DELETE RESTRICT;
...
CREATE UNIQUE INDEX "Talent.name" ON "jocasta_schema"."Talent"("name")
...
CREATE UNIQUE INDEX "_CharacterToSpecialization_AB_unique" ON "jocasta_schema"."_CharacterToSpecialization"("A","B")

CREATE UNIQUE INDEX "_SkillToSpecialization_AB_unique" ON "jocasta_schema"."_SkillToSpecialization"("A","B")

CREATE UNIQUE INDEX "_SpecializationToTalent_AB_unique" ON "jocasta_schema"."_SpecializationToTalent"("A","B")
```
...
migration watch-20200115123209..watch-20200115125140
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
